...
*/}}
{{- define "idle-reaper.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "idle-reaper.resourceName" -}}
{{- $fullname := include "idle-reaper.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "idle-reaper.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "idle-reaper.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
